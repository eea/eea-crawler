...
app_config = Variable.get("app_cca_test", deserialize_json=True)
SCHEDULE_INTERVAL = "@daily"
default_args = {"owner": "airflow"}

TASK_PARAMS = {"params": {"app": "cca_test", "enable_prepare_docs": True}}


@task
def trigger_sync(ignore_delete_threshold):
    app_id = get_app_identifier("cca_test")
...
def d0_sync_cca_test(ignore_delete_threshold=False):
    trigger_sync(ignore_delete_threshold)


sync_cca_test_dag = d0_sync_cca_test()
