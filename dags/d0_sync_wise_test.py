...
app_config = Variable.get("app_wise_test", deserialize_json=True)
SCHEDULE_INTERVAL = app_config.get("schedule_interval", "@daily")
default_args = {"owner": "airflow"}

TASK_PARAMS = {"params": {"app": "wise_test", "enable_prepare_docs": True}}
...
def d0_sync_wise_test(ignore_delete_threshold=False):
    trigger_sync(ignore_delete_threshold)


sync_wise_test_dag = d0_sync_wise_test()
